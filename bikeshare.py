...
def get_filters():
    ...
    while city_name.lower() not in CITY_DATA:
        city_name=input("/nEnter the name of city you want to analyze: (Enter either chicago, new york city, washington)/n")
        if city_name.lower() in CITY_DATA:
            city=CITY_DATA[city_name.lower()]
        else:
            print("sorry we couldn't find city name you entered!! (Enter either chicago, new york city, washington)/n")
        

    # TO DO: get user input for month (all, january, february, ... , june)
    month_name=''
    while month_name.lower() not in MONTH_DATA:
        month_name=input("/nEnter the name of month you want to analyze: (Enter either all, january, february, ... , june)/n")
        if month_name.lower() in MONTH_DATA:
            month=month_name.lower()
        else:
            print("sorry we couldn't find city name you entered!! (Enter either all, january, february, ... , june)/n")
        
    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day_name=''
    while day_name.lower() not in DAY_DATA:
        day_name=input("/nEnter the name of day you want to analyze: (Enter either all, monday, tuesday, ... sunday)/n")
        if day_name.lower() in DAY_DATA:
            day=day_name.lower()
        else:
            print("sorry we couldn't find city name you entered!! (Enter either all, monday, tuesday, ... sunday)/n")
...
def time_stats(df):
    ...
    common_day_of_week= df['month'].mode()[0]
